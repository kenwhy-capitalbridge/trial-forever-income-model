...
if (!isAllowed) {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      // --- 2. Report Title Header (clear hierarchy: CAPITAL BRIDGE > Trial Forever Income Model > subtitle) ---
      ...
      doc.setFont('helvetica', 'bold');
      doc.setFontSize(13);
      doc.text('Trial Forever Income Model', headerLeft, y + 4);
      y += 7;
      doc.setFont('helvetica', 'normal');
      doc.setFontSize(9);
          ...
          <div className="p-6 md:p-10 bg-black/10 border-b border-[#FFCC6A]/20">
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4 mb-8">
              <h2 className="text-xl font-semibold text-[#FFCC6A] flex items-center gap-2 flex-shrink-0">
                <Landmark className="w-5 h-5" /> Trial Forever Income Model
              </h2>
